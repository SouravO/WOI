  ...
  return (
    ...
    >
      <div className="max-w-4xl w-full text-center pointer-events-auto">
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/5 border border-white/10 rounded-full font-mono text-[10px] uppercase tracking-widest mb-6" style={{ color }}>
          {subtitle}
        </div>
        <h2 className="text-6xl md:text-8xl font-black uppercase tracking-tighter leading-none mb-8" style={{ color }}>
          {title}
        </h2>
        <p className="text-xl md:text-2xl text-gray-100 font-light max-w-2xl mx-auto opacity-80 leading-relaxed">
            {content}
        </p>
      </div>
    </motion.div>
